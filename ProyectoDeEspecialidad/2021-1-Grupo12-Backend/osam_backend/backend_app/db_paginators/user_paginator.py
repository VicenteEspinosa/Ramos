...
class UserPaginator(PageNumberPagination):
    ...
    def generate_response(self, query_set, serializer_obj, request):
        ...
        self.last_page = math.ceil(user_count / int(self.page_size))
        ...
        # Delete the password in the response data
        for user in serialized_page.data:
            user.pop('password', None)

        data = serialized_page.data # add the get_indexed_json_user here
