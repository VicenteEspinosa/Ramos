...
class Personaje:
	...
	def guardar(self):
		usuario.valores_finales = []
		usuario.valores_finales.append(usuario.destreza)
		usuario.valores_finales.append(usuario.resistencia)
		usuario.valores_finales.append(usuario.inteligencia)
		usuario.valores_finales.append(usuario.suerte)

	def restaurar(self):
		self.destreza = valores_finales[0]
		self.resistencia = valores_finales[1]	
		self.inteligencia = valores_finales[2]
		self.suerte = valores_finales[3]
