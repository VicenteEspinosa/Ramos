...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference("Coupon.count") do
      post coupons_url, params: { coupon: { category_id: @coupon.category_id, name: @coupon.name, value: @coupon.value } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { category_id: @coupon.category_id, name: @coupon.name, value: @coupon.value } }
