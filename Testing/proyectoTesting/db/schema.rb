...
ActiveRecord::Schema[7.0].define(version: 2022_11_11_211439) do
  ...
  create_table "movie_times", force: :cascade do |t|
    ...
    t.string "rating", default: "TODO ESPECTADOR"
    t.string "branch", default: "Santiago"
    t.string "language", default: "Ingles"
